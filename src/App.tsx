...
{t.estado==="Solicitud"&&getColabId(t)&&co2&&cl&&<Btn onClick={async()=>{window.open(buildWA(co2,t,cl),"_blank");await avanzar("Presupuestando","Trabajo enviado al colaborador");}} color="bg-green-500">📱 Enviar trabajo al colaborador</Btn>}
        ...
        {t.estado==="Colaborador disponible"&&t.ultima_novedad&&t.ultima_novedad.includes("Cliente propone")&&co2&&<Btn onClick={()=>window.open(buildWA(co2,t,cl),"_blank")} color="bg-orange-500">📱 Consultar cambio de fecha con {co2.nombre.split(" ")[0]}</Btn>}
